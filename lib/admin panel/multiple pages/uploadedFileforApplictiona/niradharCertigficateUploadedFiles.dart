...
class Niradharcertigficateuploadedfiles extends StatefulWidget {
  ...
  _NiradharcertigficateuploadedfilesState createState() =>
      _NiradharcertigficateuploadedfilesState();
}

class _NiradharcertigficateuploadedfilesState
    extends State<Niradharcertigficateuploadedfiles> {
  List filenames = [
    "निराधार नोंदणी अर्ज",
  ...
  Future<void> _openFile(String fileUrl) async {
    String formattedUrl = fileUrl.startsWith('http://')
        ? fileUrl.replaceFirst('http://', 'https://')
        : fileUrl;
    print("filurl : $formattedUrl");
    ...
    if (await canLaunchUrl(url)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Could not open the URL: $formattedUrl")),
      );
    }
  }
